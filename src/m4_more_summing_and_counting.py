...
def test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expected = 4
    answer = count_cosines_from(3, 10, 0.3)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    expected = 5
    answer = count_cosines_from(3, 11, 0.49)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    expected = 3
    answer = count_cosines_from(2, 9, 0.29)
    ...
    print('       actual:  ', answer)
    expected = 8
    answer = count_cosines_from(3, 20, 0.29)
...
def test_sum_unit_fractions_from():
    ...
    expected = 0.6
    answer = sum_unit_fractions_from(2, 9)
